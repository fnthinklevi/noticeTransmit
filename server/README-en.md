...
```json
{
  ...
  "fileSize": 56623104,
  "downloads": {
    "arm64": "https://cdn2.fnthink.top/apks/1.5.73/notice_arm64_1.5.73.apk",
    "arm32": "https://cdn2.fnthink.top/apks/1.5.73/notice_arm32_1.5.73.apk",
    "x86_64": "https://cdn2.fnthink.top/apks/1.5.73/notice_x86_1.5.73.apk",
    "all": "https://cdn2.fnthink.top/apks/1.5.73/notice_all_1.5.73.apk"
  },
  "fileSizes": {
    "arm64": 27349386,
    "arm32": 23540588,
...
| `downloads` | object | Per-platform download URLs (arm64/arm32/x86_64/all, https) | `{"arm64":"https://.../notice_arm64_1.5.73.apk",...}` |
| `fileSizes` | object | Per-platform file sizes in bytes | `{"arm64":27349386,...}` |
| `sha256` | object | Per-platform APK sha256 (v1.5.73+ transport-layer verification, compared by the app after download before install) | `{"arm64":"63c6...09b",...}` |
